...
public:
	 ...
	 */
	matrix_trans(double a, double b, double c, double d, double e, double f);

	/**
	 * \brief Initializes a projective transformation matrix with given transformation values.
	 */
	matrix_trans(double a, double b, double c, double d, double e, double f, double g, double h, double i);
	 ...
	 */
	static matrix_trans find_trans_matrix(vector_proj pre_image_points[4], vector_proj image_points[4]);
};
